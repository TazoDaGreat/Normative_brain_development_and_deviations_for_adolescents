...
This file plots the residaul differences between cortical thickness and surface area of reach race compared to white. We save pngs of every combo so we can use these to upload to the shiny instead
```{r}
library(readr)
library(dplyr)
library(tidyr)
