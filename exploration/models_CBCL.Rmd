...
brain_data_male <- read_csv("~/Library/CloudStorage/Box-Box/area/final_data_male_year4_mh.csv") %>%
...
brain_data_female <- read_csv("~/Library/CloudStorage/Box-Box/area/final_data_female_year4_mh.csv") %>%
  pivot_longer(cols = c(White_race, Black_race, AIAN_race, NHPI_race,
           Asian_race, Other_race, Missing_race, demo_ethn_v2),
      names_to = "race_ethnicity",
      values_to = "indicator") %>% 
...
brain_data_male <- brain_data_male %>%
  ...
  filter(is.finite(z_score), !is.na(z_score),
         is.finite(age), !is.na(age)) %>%
...
```
```{r}
write_csv(brain_data_male, "~/Library/CloudStorage/Box-Box/area/final_data_male_year4_mh_2.csv")
write_csv(brain_data_female, "~/Library/CloudStorage/Box-Box/area/final_data_female_year4_mh_2.csv")
```
