...
"))),
  ...
  nav_panel("Mental Health Prediction - Depression Score",
            id = "tab_6",
            tags$li(
              class = "nav-item",
            ...
            fluidRow(
              ...
              card(
                ...
                div(
                  tags$p(
                    tags$strong("Mental Health Prediciton - Depression Score"),
                  ...
                  tags$p(
                    ...
                    these predictions. Here, we predict Depression Summary Score. Using the White 
